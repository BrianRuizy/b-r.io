...
<blockquote className="text-secondary font-sans">This is a draft post, but sharing in case it's helpful or interesting already.</blockquote>
...
Here is the final code for our Map component for reference. I hope this article has helped you get started with adding maps to your React app. If you have any questions feel free to ping me on the [community chat](/community) or [Twitter](https://twitter.com/brianruizy). Happy mapping!
