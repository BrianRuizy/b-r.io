...
<Alert>
  Also, must make you aware that the following links are affiliate links, which
  means I get a small commission if you purchase through them. This is at no
  extra cost to you, but it does help me continue to create content like this.
  Thanks!
</Alert>
...
<div className="grid grid-cols-2 grid-rows-2 gap-2 rounded-lg overflow-clip">
