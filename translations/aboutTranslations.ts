...
export const aboutTranslations: Translations = {
    EN: {
        ...
        firstParagraphTitle: "About",
        firstParagraphContentOne: "Hello world, I'm Decloquement Oscar!",
        firstParagraphContentTwo: "I have a passion for new technologies and am always looking for ways to integrate them into my work.",
        firstParagraphContentThree: "When I'm not working, I'm probably lifting weights at CrossFit, running with my dog, or exploring new environments with my motorcycle.",
        secondParagraphTitle: "Connect",
        ...
        thirdParagraphContentOne: "years of experience in computer development (3 years of apprenticeship).",
        ...
        asterix: "in apprenticeship"
    },
    FR: {
        title: "À propos de moi",
        subTitle: "Un petit aperçu.",
        ...
        firstParagraphContentThree: "Quand je ne travaille pas, je suis probablement en train de soulever des poids au crossfit, de courir avec mon chien ou partir en balade sur ma moto",
