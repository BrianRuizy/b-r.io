              ...
              <AnimatePresence>
                {open && (
                  <Listbox.Options
                    ...
                    className="absolute right-0 p-2 mt-2 overflow-auto text-base origin-top-right shadow-lg max-h-60 w-42 rounded-xl bg-blur backdrop-blur-lg focus:outline-none sm:text-sm border border-primary"
                  >
                    {themes
                      .filter((theme) =>
