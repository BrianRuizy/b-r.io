...
import coverImage from './floating.png'
...
export const post = {
  ...
  author: 'Brian Ruiz',
  date: '2021-09-01',
  title: 'How I built a COVID-19 dashboard with Python',
  description:
...
So did I achieve my initial goal? Yes, more than I expected. Knowing that hundreds of thousands of people opened the site and interacted with it means a lot. And the idea that some of them learned a little more about the pandemic is still rewarding.

If you're a developer and want to dig into the code, check out the [getting started](https://github.com/BrianRuizy/covid19-dashboard/#getting-started) docs in the GitHub repository.
