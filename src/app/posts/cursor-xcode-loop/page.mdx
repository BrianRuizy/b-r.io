...
export const post = {
  ...
  description:
    'Building Beam in Cursor, I kept ping-ponging into Xcode: Run, copy errors, paste, repeat. I wired a loop so saves trigger builds, Xcode runs in the background, and the agent reads compiler output on its own.',
...
I've been building [Beam](https://trybeam.vercel.app), a project and task management app. The agent writes Swift fine; verifying it meant Xcode ping-pong (Run, copy errors, paste, repeat) and constant context switching between Cursor and Xcode. Tedious, low-value work.
