...
import nycLightImage from './nyc-light.png'
import nycDarkImage from './nyc-dark.png'
...
export const post = {
  ...
  description:
    'A step-by-step guide to embedding Mapbox Standard in React: set up the map component, configure the camera, sync light presets with your theme, add a location badge overlay, and place a custom marker.',
}
...
<figure>
  <MapDemo />
  <figcaption>
    The Met on the edge of Central Park at dusk (which is one my favorite places to visit). Mapbox Standard&apos;s dusk preset pulls a surprising amount of detail out of the buildings and tree line. It gives like an Apple Maps level of quality to your maps. This is the component we&apos;ll build toward below.
  </figcaption>
</figure>
