---
title: 'This App Idea Got Us 1st Place at a Microsoft Hackathon'
...
### Analyzing mobile telemetry data
...
Unfortunately, we didn't have enough time to implement both the backend logic and the front-end interface. However, I created a mockup of the interface, which captures the essence of the idea, and it's a good example with emphasis on a minimal user experience.
...
Finally, we needed to plot our GPS data so the city could take action. Our collected data including latitude, longitude, altitude, and location accuracy. `import folium`
